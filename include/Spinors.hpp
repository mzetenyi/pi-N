...
namespace Spinors {
  ...
  */
  ...
  public:
    ...
    friend ostream& operator << (ostream&, const PauliSpinor&);
    /// Read the spinor from the given stream. It must be in the form '(x,y)'.
    friend istream& operator >> (istream&, PauliSpinor&);
  ...
  */
  ...
  public:
    ...
    bool operator != (const AdPauliSpinor&) const;
    /// Print the spinor to the given stream in the form '(x,y)'.
    friend ostream& operator << (ostream&, const AdPauliSpinor&);
    /// Read the spinor from the given stream. It must be in the form '(x,y)'.
    friend istream& operator >> (istream&, AdPauliSpinor&);
    /// Decide if any component is NaN.
    bool isnan() const;
    /// friend classes for easier implementation.
    friend class DiracSpinor;
  ...
  */
  ...
  public:
    ...
    friend ostream& operator << (ostream&, const PauliMatrix&);
  ...
  */
  ...
  public:
    ...
    friend ostream& operator << (ostream&, const DiracSpinor&);
    /// Read the spinor from the given stream. It must be in the form '(x1,x2,x3,x4)'.
    friend istream& operator >> (istream&, DiracSpinor&);
    /// Decide if any component is NaN.
    bool isnan() const;
    /// Dirac adjoint.
  ...
  */
  ...
  public:
    ...
    bool operator != (const AdDiracSpinor&) const;
    /// Print the spinor to the given stream in the form '(x1,x2,x3,x4)'.
    friend ostream& operator << (ostream&, const AdDiracSpinor&);
    /// Read the spinor from the given stream. It must be in the form '(x1,x2,x3,x4)'.
    friend istream& operator >> (istream&, AdDiracSpinor&);
    /// Decide if any component is NaN.
    bool isnan() const;
    /// Dirac adjoint.
  ...
  */
  ...
  public:
    ...
    bool operator != (const DiracMatrix&) const;
    /// Print the matrix to the given stream in the form '((x11,x12,x13),(...),(...))'.
    friend ostream& operator << (ostream&, const DiracMatrix&);
    /// Print to a stream in the form of a table.
    void output(ostream&, int fieldWidth=20) const;
    /// Trace.
    dcomplex trace() const;
  ...
  public:
    ...
    const DiracMatrix& operator[](int) const;
    const DiracMatrix operator()(const FourVector&) const;
  private:
  ...
  public:
    ...
    const DiracMatrix operator()(int, const FourVector&) const;
    const DiracMatrix operator()(const FourVector&, int) const;
    const DiracMatrix operator()(const FourVector&, const FourVector&) const;
  private:
